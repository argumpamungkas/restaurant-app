...
class ListReview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<SettingProvider>(builder: (context, prov, _) {
      return Column(
  ...
  Widget _dialogReview(BuildContext context) {
    return Consumer<SettingProvider>(builder: (context, provSetting, _) {
      return AlertDialog(
        title: const Text(
          "Add Review",
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              "Cancel",
              style: TextStyle(
                color: provSetting.isDarkTheme ? Colors.white : Colors.black,
              ),
            ),
          ),
          TextButton(
